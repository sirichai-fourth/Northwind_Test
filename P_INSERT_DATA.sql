...
CREATE PROCEDURE dbo.P_INSERT_DATA
AS
BEGIN
    ...
    BEGIN TRY
		...
		BEGIN TRANSACTION;
			...
			INSERT INTO Customers VALUES('FISSA Fabrica Inter. Salchichas S.A.','Die Roel','C/ Moralzarzal, 86','Madrid','28034','Spain');
			INSERT INTO Customers VALUES('Folies urmandes','Martine Rancé','184, chaussée de Tournai','Lille','59000','France');
			...
			INSERT INTO Customers VALUES('dos Cocina Típica','José Pedro Freyre','C/ Romero, 33','Sevilla','41101','Spain');
			INSERT INTO Customers VALUES('urmet Lanchonetes','André Fonseca','Av. Brasil, 442','Campinas','04876-786','Brazil');
			...
			INSERT INTO Customers VALUES('LILA-Supermercado','Carlos nzález','Carrera 52 con Ave. Bolívar #65-98 Llano Lar','Barquisimeto','3508','Venezuela');
			...
			INSERT INTO Customers VALUES('Santé urmet','Jonas Bergulfsen','Erling Skakkes gate 78','Stavern','4110','Norway');
			...
			INSERT INTO Customers VALUES('Trail''''s Head urmet Provisioners','Helvetius Nagy','722 DaVinci Blvd.','Kirkland','98034','USA');
		...
		BEGIN TRANSACTION;
			...
			INSERT INTO Suppliers VALUES('Leka Trading','Chandra Leka','471 Seranon Loop, Suite #402','Singapore','512','Singapore','555-8787');
			...
			INSERT INTO Suppliers VALUES('Escarts Nouveaux','Marie Delamare','22, rue H. Voiron','Montceau','71300','France','85.57.00.07');
			INSERT INTO Suppliers VALUES('Gai pâturage','Eliane Noz','Bat. B 3, rue des Alpes','Annecy','74000','France','38.76.98.06');
			INSERT INTO Suppliers VALUES('Forêts d''érables','Chantal ulet','148 rue Chasseur','Ste-Hyacinthe','J2S 7S8','Canada','(514) 555-2955');
		COMMIT TRANSACTION;
		...
		BEGIN TRANSACTION;
			...
			INSERT INTO Products VALUES('Queso Manche La Pastora',5,4,'10 - 500 g pkgs.',38);
			...
			INSERT INTO Products VALUES('rnzola Telino',14,4,'12 - 100 g pkgs',12.5);
			...
			INSERT INTO Products VALUES('Escarts de Bourgne',27,8,'24 pieces',13.25);
